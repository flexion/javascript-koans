describe("About Objects", function () {
  ...
  describe("Properties", function () {
    ...
    xit("should confirm objects are collections of properties", function () {
      expect(meglomaniac.mastermind).toBe(FILL_ME_IN);
    });

    xit("should confirm that properties are case sensitive", function () {
  ...
  xit("should know properties that are functions act like methods", function () {
    var meglomaniac = {
      mastermind : "Brain",
      henchman: "Pinky",
  ...
  xit("should confirm that when a function is attached to an object, 'this' refers to the object", function () {
  ...
  describe("'in' keyword", function () {
    ...
    xit("should have the bomb", function () {
    ...
    xit("should not have the detonator however", function () {
  ...
  xit("should know that properties can be added and deleted", function () {
  ...
  xit("should use prototype to add to all objects", function () {

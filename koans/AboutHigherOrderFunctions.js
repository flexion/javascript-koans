...
describe("About Higher Order Functions", function () {
  ...
  xit("should use filter to return array items that meet a criteria", function () {
    var numbers = [1,2,3];
  ...
  xit("should use 'map' to transform each element", function () {
    var numbers = [1, 2, 3];
  ...
  xit("should use 'reduce' to update the same result on each iteration", function () {
    var numbers = [1, 2, 3];
  ...
  xit("should use 'forEach' for simple iteration", function () {
    var numbers = [1,2,3];
    var msg = "";
  ...
  xit("should use 'all' to test whether all items pass condition", function () {
    var onlyEven = [2,4,6];
  ...
  xit("should use 'any' to test if any items passes condition" , function () {
    var onlyEven = [2,4,6];
    var mixedBag = [2,4,5,6];
  ...
  xit("should use range to generate an array", function() {
      expect(_.range(3)).toEqual(FILL_ME_IN);
      expect(_.range(1, 4)).toEqual(FILL_ME_IN);
      expect(_.range(0, -4, -1)).toEqual(FILL_ME_IN);
  });

  xit("should use flatten to make nested arrays easy to work with", function() {
      expect(_([ [1, 2], [3, 4] ]).flatten()).toEqual(FILL_ME_IN);
  });

  xit("should use chain() ... .value() to use multiple higher order functions", function() {
